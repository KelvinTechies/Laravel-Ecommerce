                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    ...
                                    <p class="text-muted mb-1 ">Ordered Products</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    ...
                                    <p class="text-muted mb-1 ">Delivered Products</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    ...
                                    <p class="text-muted mb-1 ">Products in Cart</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
                            ...
                            <div class="progress progress-sm m-0">
                                <div class="progress-bar bg-dark" role="progressbar" aria-valuenow="74" aria-valuemin="0" aria-valuemax="100" style="width: 74%">
                            ...
                            <div class="table-responsive pt-3">
                                <table class="table table-hover table-centered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        <td><img class= ' img-thumbnail' src={{asset('cover/'.$product['products_models']['Image'])}}></td>
                                        <td>{{$product['products_models']['DogName']}}</td>
                                        <td>${{$product['products_models']['Price']}}.00</td>
                                        <td>{{$product['products_models']['Quantity']}}qty</td>
                                        <td>{{$product['products_models']['Quantity'] * $product['products_models']['Price']}}qty</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
