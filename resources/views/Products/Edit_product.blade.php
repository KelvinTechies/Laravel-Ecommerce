                    ...
                    @method('PUT')
                        <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="" class="form-control" name='dogName' id="floatingInput" value="{{$product->DogName}}">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control"value="{{$product->Breed}}" name='dogBreed' id="floatingPassword" placeholder="text">
                                    ...
                                    <textarea class="form-control" name='dogDescription' id="floatingTextarea2"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select" id="floatingSelect" name='dogColor'  aria-label="Floating label select example">
                                            ...
                                            <option value="White">{{$product->Color}}</option>
                                    ...
                                    <h4 class="header-title mt-lg-0 my-3">Type OF Product</h4>
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" name ='dogType'value="{{$product->DogType}}" id="floatingInputGrid" placeholder="Type OF Product" >
                                    ...
                                    {{-- <h4 class="header-title mt-lg-0 my-3">Quantity</h4>                                 --}}
                                            <div class="form-floating">
                                                        <input type="number" name='dogQuantity' class="form-control"value="{{$product->Quantity}}" id="floatingPassword" placeholder="">
                                        ...
                                        <div>
                                         ...
                                         <div class="mb-3">
                                            ...
                                            {{-- <div class="form-floating">
                                                ...
                                                <div class="form-floating mb-3">
                                                        <input type="number" name='dogPrice' value="{{$product->Price}}" class="form-control" id="floatingPassword" placeholder="">
                                                        <label for="floatingPassword">Price</label>
                                                    </div>
                                                </div>
                                            </div>
