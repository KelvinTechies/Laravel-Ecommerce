...
<!-- Mirrored from coderthemes.com/ubold/layouts/creative/layouts-vertical.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Sep 2022 14:10:28 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Vertical Layout | UBold - Responsive Admin Dashboard Template</title>
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="pro-user-name ms-1">
                                    {{ $userData->UserName }} <i class="mdi mdi-chevron-down"></i> 
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                                ...
                                <!-- item-->
                            <a href="/edit_user/{{$userData->id}}" class="dropdown-item notify-item">
                                    <i class="fe-user"></i>
...
<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <script>document.write(new Date().getFullYear())</script> &copy; Kinx  by <a href="#">Kinx</a> 
            </div>
            <div class="col-md-6">
